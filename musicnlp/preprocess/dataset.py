...
DATASET_NAME2MODE2FILENAME: Dict[str, Dict[str, str]] = {  # Are in pitch_kind `step`
    ...
    'MAESTRO': {
        'melody': '',
        'full': '23-06-28_Extracted-MAESTRO_{n=1276}_{md=f, prec=5, th=1}',
    },
    'POP909': {
        'melody': '',
        'full': '23-03-31_Extracted-POP909_{n=909}_{md=f, prec=5, th=1}'
    },
    'LMCI': {
        'melody': '',
    ...
    'NES-MDB': {
        'melody': '',
        'full': '23-04-17_Extracted-NES_{n=5261}_{md=f, prec=5, th=1}'
    }
}
